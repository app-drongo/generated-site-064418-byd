// Enhanced by AI on 2025-08-07T21:26:00.187Z
// Section: hero
// Category: hero

import { Button } from "@/components/ui/button"
import { ArrowRight, BarChart, Star, Users, Briefcase } from "lucide-react"
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Personalized financial consulting to help your business thrive. From cash flow management to investment strategies, I deliver tailored solutions for sustainable growth.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              ...
              <Button size="lg" variant="outline" className="group text-base px-8">
                <BarChart className="mr-2 size-5 transition-transform group-hover:scale-110" />
                View Services
              </Button>
            </div>
              ...
              <div className="rounded-2xl border bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground">Financial Strategy Overview</p>
                  </div>
                </div>
              </div>
